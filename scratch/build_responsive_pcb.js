  ...
  (function() {
    ...
    window.pcbApp = {
      ...
      TEMPLATES: [
        {
          ...
          specs: [
            'Procesador Intel Core i5 10ma Gen / 6 núcleos',
            'Placa Madre ASUS Prime H510M',
            'Memoria 16GB RAM DDR4 3200MHz',
            'Almacenamiento SSD 500GB NVMe Alta Velocidad',
            'Gabinete Vorago Micro-ATX con Fuente 500W'
          ],
          components: {
            cpu: 'bx8070110400',
            mobo: '90mb17c0-m0aay0',
            ram: 'kf432c16bb/16',
            ssd: 'snv2s/500g',
            case: 'act-gabm-400',
            psu: 'es-05001'
        ...
        },
        {
          ...
          specs: [
            'Procesador Intel Core i3 10ma Gen 4.3GHz',
            'Placa Madre ASUS H510M',
            'Memoria 16GB RAM DDR4',
            'Almacenamiento SSD 500GB NVMe M.2',
        ...
        },
        {
          ...
          specs: [
            ...
            'Tarjeta Madre Gigabyte B550M DS3H AC WiFi',
            'Memoria 16GB RAM Kingston Fury Beast DDR4',
            'Almacenamiento SSD 1TB Kingston NVMe M.2',
            'Gabinete Gamer Balder Flow Mesh + 4 Fans ARGB',
            'Fuente Certificada 650W 80+ Bronze'
          ],
          components: {
            cpu: '100-100000457box',
            mobo: 'b550m ds3h ac',
            ram: 'kf432c16bb/16',
            ssd: 'snv2s/1000g',
            case: 'balder-flow',
        ...
        },
        {
          ...
          specs: [
            ...
            'Placa Madre Gigabyte B550M DS3H WiFi',
            'Memoria 32GB RAM Dual Channel DDR4',
            'Almacenamiento SSD 1TB NVMe Gen4 Ultra',
            'Gabinete Mesh de Alto Flujo de Aire',
            'Fuente 750W 80 Plus Gold'
          ],
          components: {
            cpu: '100-100000926wof',
            mobo: 'b550m ds3h ac',
            ram: 'kf432c16bb/16',
            ssd: 'snv2s/1000g',
            case: 'balder-flow',
            ...
            <div class="pcb-tpl-card">
              ...
              <div>
                <div class="pcb-tpl-price-box">
                  <span style="font-size:0.82rem; color:#64748b; font-weight:600;">Estimado desde:</span>
      ...
      loadTemplateDirect: function(templateId) {
        ...
        alert('✅ ¡Configuración "' + tpl.title + '" cargada con éxito! Puedes personalizar o cambiar cualquier componente.');
      },
